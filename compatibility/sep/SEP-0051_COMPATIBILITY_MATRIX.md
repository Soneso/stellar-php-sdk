...
|---------|--------|-------|
| `Integer (32-bit)` | ✅ Supported | Native PHP int; json_encode emits a JSON number. Generated struct fromJsonValue checks is_int/is_string. `tools/xdr-generator/generator/generator.rb:2796` |
| `Unsigned Integer (32-bit)` | ✅ Supported | Native PHP int; json_encode emits a JSON number. Same path as int32. `tools/xdr-generator/generator/generator.rb:2796` |
...
| `Boolean` | ✅ Supported | JSON true/false via PHP native bool. `tools/xdr-generator/generator/generator.rb:3776` |
...
| `Arrays (Fixed Length)` | ✅ Supported | JSON array; elements encoded according to element type. Generator emits PHP array via foreach/toJsonValue on each element. `tools/xdr-generator/generator/generator.rb:662` |
| `Arrays (Variable Length)` | ✅ Supported | JSON array; elements encoded according to element type. Same generator path as fixed-length arrays. `tools/xdr-generator/generator/generator.rb:3662` |
...
| `Struct` | ✅ Supported | JSON object with snake_case keys; generated by xdr-generator for all *Base.php struct files. `tools/xdr-generator/generator/generator.rb:2796` |
| `Discriminated Union` | ✅ Supported | Four sub-arm shapes supported: void arm (JSON string), non-void arm (JSON object), multi-void (JSON string for each void case), int-cased (discriminant-name + integer). Union emitter at `tools/xdr-generator/generator/generator.rb:3164`; $schema strip at `tools/xdr-generator/generator/generator.rb:3162` |
| `Void` | ✅ Supported | Void union arms render as the discriminant string (JSON string). Void in struct context is omitted. `tools/xdr-generator/generator/generator.rb:3164` |
...
| `AssetCode12` | ✅ Supported | Trim-and-pad rule per SEP-0051; XdrJsonHelper::escapeString. `Soneso/StellarSDK/Xdr/XdrAssetAlphaNum12Base.php:50` |
...
| Feature | Status | Notes |
|---------|--------|-------|
| `$schema strip on input` | ✅ Supported | fromJsonValue in generated struct and union files strips $schema before dispatch. Emitted by xdr-generator at `tools/xdr-generator/generator/generator.rb:2791` |
