...
/**
 * Unit tests for SEP-45 Web Authentication for Contract Accounts
 *
 * This test suite validates the SEP-45 authentication flow using mocked HTTP responses.
 * Tests include:
