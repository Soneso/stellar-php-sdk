...
class SorobanTest extends TestCase
{
    ...
    public function testSorobanTransactionEventsParsing(): void
    {
        ...
        $this->assertCount(21, $txResponse->events->diagnosticEventsXdr);
        ...
        foreach ($txResponse->events->diagnosticEventsXdr as $eventXdr) {
        ...
        foreach ($txResponse->events->transactionEventsXdr as $eventsList) {
