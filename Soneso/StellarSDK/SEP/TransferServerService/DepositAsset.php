...
{
    /**
     * @var bool $enabled true if SEP-6 deposit for this asset is supported
     */
    public bool $enabled;
    /**
    ...
    /**
     * @param bool $enabled true if SEP-6 deposit for this asset is supported
     */
     ...
     * @return DepositAsset the object containing the parsed data.
     */
    public static function fromJson(array $json) : DepositAsset
    {
        ...
        $result = new DepositAsset($enabled);
