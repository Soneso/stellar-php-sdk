    ...
    public static function fromJsonValue(mixed $value): static {
        ...
        if (!is_array($value)) {
            throw new InvalidArgumentException(
                'Expected object for XdrSCSpecFunctionInputV0 JSON value, got ' . get_debug_type($value)
            );
        }
        $value = XdrJsonHelper::normalizeFieldAlias($value, 'type', 'type_', 'XdrSCSpecFunctionInputV0');
        XdrJsonHelper::rejectUnknownFields($value, ['doc', 'name', 'type'], 'XdrSCSpecFunctionInputV0');
        if (!array_key_exists('doc', $value)) {
            throw new InvalidArgumentException(
                'Missing required field doc for XdrSCSpecFunctionInputV0'
            );
        }
        ...
        if (!array_key_exists('name', $value)) {
            throw new InvalidArgumentException(
                'Missing required field name for XdrSCSpecFunctionInputV0'
            );
        }
        ...
        if (!array_key_exists('type', $value)) {
            throw new InvalidArgumentException(
                'Missing required field type for XdrSCSpecFunctionInputV0'
            );
        }
