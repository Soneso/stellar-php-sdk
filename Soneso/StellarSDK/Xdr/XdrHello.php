...
class XdrHello {
    ...
    public static function fromJsonValue(mixed $value): static {
        ...
        XdrJsonHelper::rejectUnknownFields($value, ['ledger_version', 'overlay_version', 'overlay_min_version', 'network_id', 'version_str', 'listening_port', 'peer_id', 'cert', 'nonce'], 'XdrHello');
