...
class XdrSCSpecEventParamV0 {
    ...
    public static function fromJsonValue(mixed $value): static {
        ...
        $value = XdrJsonHelper::normalizeFieldAlias($value, 'type', 'type_', 'XdrSCSpecEventParamV0');
        XdrJsonHelper::rejectUnknownFields($value, ['doc', 'name', 'type', 'location'], 'XdrSCSpecEventParamV0');
        ...
        $location = XdrSCSpecEventParamLocationV0::fromJsonValue($value['location']);
        return new static($doc, $name, $type, $location);
    }
