...
class XdrSCSpecUDTStructFieldV0 {
    ...
    public static function fromJsonValue(mixed $value): static {
        ...
        $value = XdrJsonHelper::normalizeFieldAlias($value, 'type', 'type_', 'XdrSCSpecUDTStructFieldV0');
        XdrJsonHelper::rejectUnknownFields($value, ['doc', 'name', 'type'], 'XdrSCSpecUDTStructFieldV0');
