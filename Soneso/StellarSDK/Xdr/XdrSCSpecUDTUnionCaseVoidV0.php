    ...
    public static function fromJsonValue(mixed $value): static {
        ...
        if (!is_array($value)) {
            throw new InvalidArgumentException(
                'Expected object for XdrSCSpecUDTUnionCaseVoidV0 JSON value, got ' . get_debug_type($value)
            );
        }
        XdrJsonHelper::rejectUnknownFields($value, ['doc', 'name'], 'XdrSCSpecUDTUnionCaseVoidV0');
        if (!array_key_exists('doc', $value)) {
            throw new InvalidArgumentException(
                'Missing required field doc for XdrSCSpecUDTUnionCaseVoidV0'
            );
        }
        ...
        if (!array_key_exists('name', $value)) {
            throw new InvalidArgumentException(
                'Missing required field name for XdrSCSpecUDTUnionCaseVoidV0'
            );
        }
