...
class XdrClaimableBalanceEntryExtV1Ext {
    ...
    public static function decode(XdrBuffer $xdr): XdrClaimableBalanceEntryExtV1Ext {
        $v = $xdr->readInteger32();
        $result = new XdrClaimableBalanceEntryExtV1Ext($v);
        switch ($result->v) {
            case 0:
                break;
            default:
                throw new InvalidArgumentException("Unknown XdrClaimableBalanceEntryExtV1Ext discriminant: " . $result->v);
        }
        return $result;
    }
