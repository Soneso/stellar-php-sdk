...
class XdrAccountEntry {
    ...
    public static function fromJsonValue(mixed $value): static {
        ...
        XdrJsonHelper::rejectUnknownFields($value, ['account_id', 'balance', 'seq_num', 'num_sub_entries', 'inflation_dest', 'flags', 'home_domain', 'thresholds', 'signers', 'ext'], 'XdrAccountEntry');
