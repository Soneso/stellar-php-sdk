...
/**
 * Represents a trustline sponsorship removed effect from the Stellar network
 *
 * This effect occurs when sponsorship for a trustline's base reserve is removed.
 *
